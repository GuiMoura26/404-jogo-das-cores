...
// numeoro = Math.pow(2, 3); //  Expoente

// numero = Math.sqrt(36); // Raiz

// numero = Math.PI; // PI

// numero = Math.sin(0*Math.PI / 4); // Sin Seno ou coss coseno

// console.log(numero);

// let numero = Math.ceil(Math.random() * 100); // Gerar numeros aleatorios arredondados pra cima
